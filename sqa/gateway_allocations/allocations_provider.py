...
GATEWAY_ADDRESS = AsyncWeb3.to_checksum_address(
    os.environ.get('GATEWAY_REGISTRY_CONTRACT_ADDR', '0x9657d3dB87963d5e17dDa0746972E6958401Ab2a')
)
WORKER_REGISTRATION_ADDRESS = AsyncWeb3.to_checksum_address(
    os.environ.get('WORKER_REGISTRATION_CONTRACT_ADDR', '0x6867E96A0259E68A571a368C0b8d733Aa56E3915')
)
